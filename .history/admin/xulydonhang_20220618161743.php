...
<?php
    if(isset($_GET['xoa'])) {
      ...
      $sql_deletete_giaodich = mysqli_query($con, "DELETE FROM tbl_giaodich WHERE donhang_id = '$id'");
    }
    ...
    <div class="container body">
      ...
      ?>
          ...
          ?>
              ...
              ?></td>
                                        <td style="text-align: center;"><a style="font-size: 14px;display:block;"
                                                href="?xoa=<?php echo $row_donhang['khachhang_id'] ?>"
                                                class="btn btn-danger mb-2"><i class="fa fa-trash"
                                                    aria-hidden="true"></i></a> <a
                                                href="?quanly=xemdonhang&mahang=<?php echo $row_donhang['mahang'] ?>"
                                                style="font-size: 14px;display:block" class="btn btn-primary"><i
