...
if (isset($_POST['message']) && isset($_POST['email'])) {
  ...
  try {
    ...
    //email settings
    $mail->isHTML(true);
    $mail->Subject = "Cảm ơn bạn $email đã gửi thư đến chúng tôi!";
    $mail->Body = $message;
                ...
                <div class="col-md-12">
                  <form action="" class="sub-form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-12">
                      <input type="email" name="email" class="form-control col-md-6" id="" placeholder="Email..." value="<?php echo   $row_lh['email'] ?>">
