...
<body class="nav-md">
                ...
                <table class="table table-bordered">
                  ...
                  ?>
                    <tr style="text-align:center">
                      ...
                      <a href="xulysanpham.php?quanly=capnhat&capnhat_id=<?php echo $row_sp['sanpham_id'] ?>" style="font-size: 14px" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                    </tr>
                  <?php
                  }
                  ?>
  ...
  <script>
    ...
    console.log("🚀 ~ file: xulysanpham.php ~ line 419 ~ btnDelete", btnDelete)
