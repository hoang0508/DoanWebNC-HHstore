						...
						<tbody>
							...
							<tr>
								<td colspan="7" class="text-right">
									<input type="submit" class="btn btn-cart" value="Cập nhật giỏ hàng" name="capnhatsoluong">
									<?php
									...
									?>
										...
										?>
										<input type="submit" class="btn btn btn-cart" value="Thanh toán giỏ hàng" name="thanhtoandangnhap">
								</td>
							<?php
									}
							?>
