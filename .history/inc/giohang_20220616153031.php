						...
						<tbody>
							...
							<tr>
								<td colspan="7" class="text-right">
									<input type="submit" class="btn btn-car--update" value="Cập nhật giỏ hàng" name="capnhatsoluong">
									<?php
									...
									?>
										...
										?>
										<input type="submit" class="btn btn btn-cart--price" value="Thanh toán giỏ hàng" name="thanhtoandangnhap">
								</td>
							<?php
									}
							?>
