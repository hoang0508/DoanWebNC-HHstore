						...
						<tbody>
							...
							<tr>
								<td colspan="7" class="text-right">
									<button type="submit" class="btn-cart btn-cart--update" value="Cập nhật giỏ hàng" name="capnhatsoluong">
									<?php
									...
									?>
										...
										?>
										<button type="submit" class="btn-cart btn btn-cart--price" value="Thanh toán giỏ hàng" name="thanhtoandangnhap">
								</td>
							<?php
									}
							?>
