								...
								<tr>
									<td colspan="7" class="text-right">
										...
										?>
											...
											?>
											<button type="button" class="btn-cart btn-cart--price" value="Thanh toán giỏ hàng" name="thanhtoandangnhap">Thanh toán giỏ hàng</button>
									</td>
								<?php
										}
								?>
...
$(document).ready(function() {
    $('.btn-cart--price').click(function(e) {
        ...
        $.ajax({
            ...
            url: './ajax/mail.php',
            data: {
							thanhtoan_product_id: "<?= json_encode($array_productId)  ?>",
