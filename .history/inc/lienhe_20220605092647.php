 ...
 <div class="contact__addrress">
        <div class="container">
            <div class="contact__address-list">
                <div class="address-list_item">
                    ...
                    <h3 class="address-title">Main store address</h3>
                ...
                <div class="address-list_item">
                    ...
                    <h3 class="address-title">Working hours</h3>
    ...
    <div class="contact__partner">
        <div class="container">
            <div class="title-center">
                <h3 class="contact-title partner-title product-title">Partner outlet stores</h3>
            </div>
    ...
    <div class="contact__maps">
        <div class="contact__maps-epu">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3723.6575906466296!2d105.78278231429816!3d21.046382392553813!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135abb158a2305d%3A0x5c357d21c785ea3d!2zxJDhuqFpIGjhu41jIMSQaeG7h24gTOG7sWM!5e0!3m2!1svi!2s!4v1620222558644!5m2!1svi!2s"
                width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        </div>
        <form action="" class="form-maps">
            <div class="form__singup">
                <h3 class="singup-title">Drop us a line</h3>
                <div class="signup-form_row">
                    <div class="signup-form_group">
                        <label for="name" class="signup-form_label">Your name</label>
                        <input type="text" class="signup-form_input" id="name" required placeholder="Huy Hoang">
                    </div>
                    <div class="signup-form_group">
                        <label for="email" class="signup-form_label">Email adddress</label>
                        <input type="email" class="signup-form_input" id="name" placeholder="Email" required>
                    </div>
                </div>
                <div class="signup-form_row">
                    <div class="signup-form_group">
                        <label for="name" class="signup-form_label">Your phone</label>
                        <input type="text" class="signup-form_input" id="name" placeholder="Phone" required>
                    </div>
                    <div class="signup-form_group">
                        <label for="email" class="signup-form_label">Subject</label>
                        <input type="email" class="signup-form_input" placeholder="Subject" id="name" required>
                    </div>
                </div>
                <div class="signup-form_text">
                    <label for="name" class="signup-form_label">Message</label>
                    <textarea name="" id="" cols="30" rows="10"></textarea>
                </div>
                <button class="sigin-form_submit" type="submit">
                        <p class="submit-txt">Send Messenger</p>
                      </button>
            </div>
        </form>
    </div>
