    ...
    <div class="container">
        <div class="contact__address-list">
            <div class="address-list_item">
                ...
                <a href="" class="addres-link">Click to see map <i class="fa fa-chevron-right"
        ...
        <div class="form__singup">
            ...
            <div class="signup-form_row">
                <div class="signup-form_group">
                    ...
                    <input type="text" class="signup-form_input" id="name" required placeholder="Name..." name="user">
                </div>
                <div class="signup-form_group">
            ...
            <div class="signup-form_row">
                ...
                <div class="signup-form_group">
                    ...
                    <input type="text" class="signup-form_input" name="adress" placeholder="Địa chỉ..." id="name" required>
                </div>
            </div>
